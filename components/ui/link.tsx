...
const linkVariants = cva(
  "font-bold leading-[1.66] text-[12px] items-center justify-center gap-2 whitespace-nowrap dark:text-white transition-all [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-ring/50 focus-visible:ring-[3px] cursor-pointer",
  {
    variants: {
      variant: {
